...
#### Installation
Install the plugin via Bower or copy the provided CSS and JS files to your site and include them in the `<head>` tag. Be sure to reference the JS after jQuery.
```
